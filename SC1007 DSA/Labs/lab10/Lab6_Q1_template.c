...
void BFS(Graph g, int v){
    ...
    // adjust starting vertex v for 0-based indexing to be used in graph internal representation
    v = v - 1; // NOTE !!
    ...
    while (!isEmptyQueue(q)) {
        ...
        int w = dequeue(&q);
        // print the current vertex (adjust for 1-based indexing)
        printf("%d ", w + 1);
