...
// such that int** board = the dynamically-allocated 2D array, int n = board size, int col = current column index i.e. current column being solved for in the recursive function
